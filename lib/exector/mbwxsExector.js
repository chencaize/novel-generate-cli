...
var Piscina = require("piscina").Piscina;
var index_1 = require("./index");
var vir_1 = require("../vir");
var MbwxsExector = /** @class */ (function (_super) {
    __extends(MbwxsExector, _super);
    function MbwxsExector() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MbwxsExector.prototype.exec = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var tasks, order, i, j, res, buffers, newBuffer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.threadpool = new Piscina({
                            filename: vir_1.CONST_VIRS.threadpool.filename,
                            minThreads: config.threadnumber,
                            maxThreads: config.threadnumber,
                        });
                        tasks = [];
                        order = 0;
                        for (i = config.startchapter - 1; i < config.endchapter; i++) {
                            ...
                            if (config.pageperchapter > 1) {
                                for (j = 1; j <= config.pageperchapter; j++) {
                    ...
                    case 1:
                        ...
                        res.forEach(function (item) {
                            if (item === null || item === void 0 ? void 0 : item.buffer) {
                                buffers.push(Buffer.from(item.buffer));
                            }
                        });
                        newBuffer = Buffer.concat(buffers);
                        return [2 /*return*/, newBuffer];
                }
            });
        });
    };
